...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_marian9.git>
...
<https://marianagyby.github.io/521_new_repo/>
...
```{R echo=FALSE}
print("This line of code will not be displayed")
```

The 'echo' option is true by default, and it makes sure that the code
chunk is displayed in the output document. Since echo was set to FALSE,
the output of the code will be displayed, but the code itself will not
be displayed.
...
print("This code chunk will be displayed but not run")
```

The echo option here is TRUE, so the code chunk will be displayed in the
render, however, eval is set to FALSE, so the code chunk will not be run
and we will not see the output of the print statement.
...
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_marian9/blob/master/question7.html
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_marian9/blob/master/question7.pdf
...
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_marian9/blob/master/question8.Rmd
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_marian9/blob/master/question8.html
...
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_marian9/blob/master/question9.md

Markdown renders nicely on github and you can see the intended format of the text blocks and code chunks.
