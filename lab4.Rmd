...
The 'include' option is true by default, and it makes sure that the code chunk is included in the document after running.
So the code chunk above will not be included since it was set to FALSE.
